...
Solver of 1st Order Ordinary Differential Equations (ODEs): y'(x) = f(x,y) using Euler's different methods with different step sizes "h" in the region [x0,xf] in the x-axis with initial condition y0=y(0).
